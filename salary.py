...
def get_info(url):
    ...
    try:
        ...
        for i in range(535):
            ...
            player = selector.xpath(fixed_path + '[' + str(i) + ']/td[1]/a/text()')
            if not player:
                continue
            player = player[0]

            team = selector.xpath(fixed_path + '[' + str(i) + ']/td[2]/a/text()')
            if not team:
                continue
            team = team[0]

            salary = selector.xpath(fixed_path + '[' + str(i) + ']/td[3]/text()')
            if not salary:
                continue
...
#//*[@id="player-contracts"]/tbody/tr[1]/td[3]
#//*[@id="player-contracts"]/tbody/tr[21]/th[1]
#//*[@id="player-contracts"]/tbody/tr[23]/td[1]/a