...
stopwords = [line.strip() for line in open('./TencentFiles/stopwords.txt').readlines()]
stopwords += [line.strip() for line in open('./TencentFiles/stopwords2.txt', encoding="gbk").readlines()]
stopwords += [line.strip() for line in open('./TencentFiles/stopwords3.txt', encoding="gbk").readlines()]
...
#文本分词 去停用词
df = pd.read_csv("./TencentFiles/cn.csv")
